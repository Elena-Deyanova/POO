...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("BIENVENID@ A TU BANCO!!");
        do{
            Banco.menu(); 
            ...
            switch (opcion) {
                case 1: // ver todas las cuentas que hay en el banco
                    banco.ver_cuentas(); 
                    break;

                case 2: //ingresar dinero a alguna cuenta
                    banco.ver_cuentas();
                ...
                case 3: // retirar dinero de alguna cuenta 
                    banco.ver_cuentas();
                ...
                case 4://tramsferencia de una cuenta a otra
                ...
                case 5: //agregar una cuenta al banco
                ...
                case 6:  // eliminar una cuenta del banco 
                ...
                case 7: // buscar por el nombre que contenga x 
                    System.out.print("Dime la palabra que quieres buscar: ");
                    nombre = lector.nextLine(); 

                    banco.buscar_cuenta(nombre);
                    break;

                case 8:  // printa la lista de morosos 
                    banco.mostrar_morosos();
                    break; 

                case 9: // finaliza y sale del programa
                    System.out.println("Hasta luego!!");
                    break;

                default: //opcion por si se introduce una opcion que no es valida
